...
import com.example.simmobile.data.DxData
import com.example.simmobile.data.CriaMdsData
import com.example.simmobile.interfaces.QuatroDxAplication
...
class CriarDx : AppCompatActivity() {
    ...
    fun registerMds(){
        ...
        val retrofit = ClientRetrofit.criarCliente("teste")
